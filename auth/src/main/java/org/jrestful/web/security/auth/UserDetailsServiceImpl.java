...
public class UserDetailsServiceImpl<U extends AuthUser<K>, K extends Serializable> implements UserDetailsService {
  ...
  @Autowired
  public UserDetailsServiceImpl(AuthUserService<U, K> userService, UserIdConverter<K> userIdConverter) {
